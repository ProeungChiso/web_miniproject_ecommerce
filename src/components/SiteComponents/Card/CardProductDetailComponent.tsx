                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt={name}
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4"><span className="flex items-center">
                            ...
                            <p className="mb-5 md:mb-20 font-bold text-violet-800">Seller: {seller}</p>
                            <div className="flex items-center">
                                <span className="title-font font-medium text-2xl text-gray-900">{price} $</span>
                                <button
                                    className="flex ml-auto text-white bg-violet-800 border-0 py-2 px-6 focus:outline-none hover:bg-violet-600 rounded">
                                    Add to Card
                                </button>
                                <button
