...
const RegisterForm = () => {
    ...
    async function handleRegister(values: any) {
        ...
        try {
            const postData = await fetch("https://store.istad.co/api/user/register/", {
                method: "POST",
    ...
    return (
        <div className="w-auto md:w-[500px] bg-white rounded-lg shadow-sm">
            <h1 className="text-lg md:text-2xl text-center font-bold">
                <span className="text-violet-800">Among-Ecommerce</span> Register
            </h1>
            <Formik
